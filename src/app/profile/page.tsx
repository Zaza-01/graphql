...
export const dynamic = "force-dynamic"; // disables ISR/static cache
...
const USER_QUERY = gql`
  query User {
    user {
      ...
      TransactionsFiltered1: transactions(
        where: {
          type: { _eq: "xp" },
          path: {
            _like: "%bh-module%",
      ...
      <div className='profile-grid'>
        <div className='user-info card'>
          ...
          <div className="info">
            ...
            <p className='font-title'>&emsp;Your Level : <span className='font-text2 font-medium'>{userLevel[0]?.level ?? 'N/A'}</span></p>
          </div>
        </div>
        ...
        <div className='bar-chart card'>
          ...
          <BarChart data={event_user} userEventId={user[0].groupsByCaptainid.at(-1).eventId} />
        </div>
